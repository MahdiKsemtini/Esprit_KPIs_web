...
class ClassesNiveaux extends StatefulWidget {
  const ClassesNiveaux({Key? key}) : super(key: key);

  @override
  State<ClassesNiveaux> createState() => _ClassesNiveauxState();
}

class _ClassesNiveauxState extends State<ClassesNiveaux> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SafeArea(
          ...
          builder: (context) => ClassesList( niveaux: niveaux[index]),
        ))
              },
              child: Container(
